...
@section('content')
		...
		<form action="{{ route('products_dashboard.store') }}" method="POST" role="form" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-6">
					{{ csrf_field() }}
			...
			<div class="row">
				<div class="col-lg-12">
					<hr>
					<a href="{{ route('products_dashboard.index.dashboard') }}" class="btn btn-danger">
