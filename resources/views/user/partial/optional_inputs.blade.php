<div class="form-group">
	<div class="col-md-4 col-lg-4 ">
		...
		<div class="input-group">
			...
			{!! Form::text('facebook', $user->facebook, ['ng-disabled'=>'disabled','class'=>'form-control input-sm']) !!}
		</div>
	</div>
</div>
...
<div class="form-group">
	<div class="col-md-4 col-lg-4 ">
		...
		<div class="input-group">
			...
			{!! Form::text('twitter', $user->twitter, ['ng-disabled'=>'disabled','class'=>'form-control input-sm']) !!}
		</div>
	</div>
</div>
...
<div class="form-group">
	<div class="col-md-4 col-lg-4 ">
		...
		<div class="input-group">
			...
			{!! Form::text('website', $user->website, ['ng-disabled'=>'disabled','class'=>'form-control input-sm']) !!}
		</div>
	</div>
</div>
